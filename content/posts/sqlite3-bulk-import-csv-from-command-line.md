...
I absolutely love [SQLite](http://www.sqlite.org/), be it windows, linux or mac, this lightweight database never stops to amaze me.
 ...
 The entire import of 28,122,486 rows was finished in less than 6 minutes and surprisingly the SQLite file database took less space than the original CSV, the original file was 4.2 GB whereas the SQLite database file was only 3.13 GB, that's a whopping gig difference.
