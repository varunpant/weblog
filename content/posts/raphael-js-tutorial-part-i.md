...
,finally its distributed under [MIT license](http://raphaeljs.com/license.html). In this tutorial ,I intend to introduce basics of this library and help you get started. 
 ...
 Lets begin with some basic concepts. [Raphael.JS](http://raphaeljs.com/) uses the SVG W3C Recommendation and VML as a base for creating graphics, it hides quite a lot of technology specific nitty-gritties and instead presents a unified api model. Here is a quick code sample
